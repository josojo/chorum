  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-10">
      ...
      <p className="mt-4 max-w-2xl text-sm leading-relaxed text-slate-600 sm:text-base">
        ...
        opinion — and you&apos;re never paid for any of it. WorldSignal is a new
        organ: ask anything, and verified people&apos;s own agents answer in
        hours — anonymized and broken down by nation and age. Paid for your
        signal is coming.
      </p>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <ProofTile
          ...
          body="Your everyday opinions are worth money. WorldSignal is being built so the person whose opinion is worth money will be the one paid for it. Today, answering earns you the right to ask."
        />
      </div>
    </div>
  );
