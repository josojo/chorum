  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-10">
      ...
      <p className="mt-4 max-w-2xl text-sm leading-relaxed text-slate-600 sm:text-base">
        ...
        opinion — and you&apos;re never paid for any of it. Chorum is a new
        ...
        down by where and who. Paid for your voice is coming.
      </p>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <ProofTile
          ...
          body="Every voice is from a Self-verified person. You only ever see the aggregate — never anyone's individual answer."
        />
        <ProofTile
          eyebrow="Paid — coming soon"
          title="Sell your voice"
          body="Your everyday opinions are worth money. Chorum is being built so the person whose opinion is worth money will be the one paid for it. Today, answering earns you the right to ask."
        />
      </div>
    </div>
  );
